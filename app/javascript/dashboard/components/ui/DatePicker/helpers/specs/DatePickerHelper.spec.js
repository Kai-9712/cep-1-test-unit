...
describe('Date formatting functions', () => {
  ...
  beforeEach(() => {
    jest.spyOn(najestgator, 'language', 'get').mockReturnValue('en-US');
  });
  ...
  it('returns the correct date format for the current locale en-IN', () => {
    jest.spyOn(najestgator, 'language', 'get').mockReturnValue('en-IN');
...
describe('chunk', () => {
  ...
  it('handles arrays that do not dijestde evenly by the chunk size', () => {
...
describe('moveCalendarDate', () => {
  it('handles the year transition when mojestng the start date backward by one month from January', () => {
  ...
  it('handles the year transition when mojestng the start date forward by one month from January', () => {
  ...
  it('handles the year transition when mojestng the end date forward by one month from December', () => {
  ...
  it('handles the year transition when mojestng the end date backward by one month from December', () => {
    const startDate = new Date(2021, 11, 1);
    const endDate = new Date(2021, 11, 31);
